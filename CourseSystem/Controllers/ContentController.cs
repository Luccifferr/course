    ...
    public class ContentController : Controller
    {
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            if (_context.Contents == null)
            {
                ...
                return Json(new { silindimi = false, hataMesaji = "Entity set 'ApplicationDbContext.Contents'  is null." });
            }
            var category = await _context.Contents.FindAsync(id);
            if (category != null)
            {
                _context.Contents.Remove(category);
            }
